...
import 'package:onboarding_screen_example/config/palette.dart';
import 'package:ons/flutter_icons.dart';

class LoginSignupScreen2 extends StatelessWidget {
  @override
...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("assets/friendly.jpg"),
                      fit: BoxFit.fill)),
              child: Container(
                padding: EdgeInsets.only(top: 90, left: 20),
                color: Color(0xFF43A047).withOpacity(.85),
                child: Column(
                    ...
                    RichText(
                      ...
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text:
                                  isSignupScreen ? " INTERMIDIARY," : " Back,",
                              style: TextStyle(
                                fontSize: 25,
                                fontWeight: FontWeight.bold,
                                color: Colors.white,
  ...
  Container buildSigninSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(Icons.mail_outline, "info@ayamlalo.com", false, true),
              ...
              ? Container(
                  decoration: BoxDecoration(
                      gradient: LinearGradient(
                          colors: [Colors.white, Palette.activeColor],
